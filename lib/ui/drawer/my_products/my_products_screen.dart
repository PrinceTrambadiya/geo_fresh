...
class MyProductsScreen extends StatefulWidget {
  ...
  const MyProductsScreen({Key key, this.arguments}) : super(key: key);
...
class _MyProductsScreenState extends State<MyProductsScreen> {
  ...
  Widget productCard(BuildContext context, FarmerState state,
    ...
    return InkWell(
      onTap: () {
        Navigator.of(context).pushNamed('/product_bid_list_screen',
            arguments: {"product": productListData, "userModel": userModel});
      },
      child: Card(
        elevation: 2.0,
